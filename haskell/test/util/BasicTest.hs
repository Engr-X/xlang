...
isIntTests :: [TestCase]
isIntTests = map (\(c, e) -> UB.isInt c --> e) [
...
isDoubleTests :: [TestCase]
isDoubleTests = map (\(c, e) -> UB.isDouble c --> e) [
...
isLongDoubleTests :: [TestCase]
isLongDoubleTests = map (\(c, e) -> UB.isLongDouble c --> e) [
    ("1.0l", True), ("2.L", True), ("1e3l", True), (".5L", True),
    ("123", False), ("123L", False), ("1.0", False), ("1e3", False)]

isNumberTest :: [TestCase]
isNumberTest =  map (\(c, e) -> UB.isNumber c --> e) [("+1e+10", True), ("123", True), ("0xFFFFFGF", False), ("123lf", False)]
...
tests = [
    ...
    testGroup "Util.Basic.isInt" isIntTests,
    testGroup "Util.Basic.isLong" isLongTests,
    testGroup "Util.Basic.isHexInt" isHexIntTests,
    testGroup "Util.Basic.isHexLong" isHexLongTests,
    testGroup "Util.Basic.isFloat" isFloatTests,
    testGroup "Util.Basic.isDouble" isDoubleTests,
    testGroup "Util.Basic.isLongDouble" isLongDoubleTests,
    testGroup "Util.Basic.isNumber" isNumberTest,
