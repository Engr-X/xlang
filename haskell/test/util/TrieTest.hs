...
tests :: [TestGroup]
tests = [
    testGroup "Util.Trie.prefixLengths" prefixLengthsTests,
    testGroup "Util.Trie.longestPrefixLength" longestPrefixLengthTests,

    testGroup "Util.Trie.eatLongest" eatLongestTests,
    testGroup "Util.Trie.contains" containsTests,
    testGroup "Util.Trie.hasPrefix" hasPrefixTests]