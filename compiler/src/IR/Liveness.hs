...
instrRD (TAC.GetFuncAddr dst _) = mkRD [] [dst]
instrRD (TAC.ICallPtr dst fn args) = mkRD (fn : args) [dst]
instrRD (TAC.ICallStaticDirect dst _ args) = mkRD args [dst]
instrRD (TAC.ICallStatic dst _ args) = mkRD args [dst]
instrRD (TAC.ICallVirtual dst _ args) = mkRD args [dst]
