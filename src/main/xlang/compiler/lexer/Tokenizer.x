...
val INVALID_IDENTITY_NAME_ERROR_MSG: pointer<char> = "invalid identifier name: "
...
val KW_CONSTRUCTOR: int = 108
val KW_CONTINUE: int = 109
val KW_DO: int = 110
val KW_DOUBLE: int = 111
val KW_ELIF: int = 112
val KW_ELSE: int = 113
val KW_FALSE: int = 114
val KW_FINAL: int = 115
val KW_FLOAT: int = 116
val KW_FOR: int = 117
val KW_FROM: int = 118
val KW_FUN: int = 119
val KW_IF: int = 120
val KW_IFF: int = 121
val KW_IMPLIES: int = 122
val KW_IMPORT: int = 123
val KW_INLINE: int = 124
val KW_INT: int = 125
val KW_INTRINSIC: int = 126
val KW_INV: int = 127
val KW_IS: int = 128
val KW_LONG: int = 129
val KW_LOOP: int = 130
val KW_MUT: int = 131
val KW_NAND: int = 132
val KW_NATIVE: int = 133
val KW_NEW: int = 134
val KW_NIFF: int = 135
val KW_NIMPLIES: int = 136
val KW_NOR: int = 137
val KW_NULL: int = 138
val KW_OR: int = 139
val KW_PACKAGE: int = 140
val KW_PASS: int = 141
val KW_POINTER: int = 142
val KW_PRIVATE: int = 143
val KW_PROTECTED: int = 144
val KW_PUBLIC: int = 145
val KW_REPEAT: int = 146
val KW_RETURN: int = 147
val KW_SHL: int = 148
val KW_SHORT: int = 149
val KW_SHR: int = 150
val KW_SIZEOF: int = 151
val KW_STATIC: int = 152
val KW_STRUCT: int = 153
val KW_TRUE: int = 154
val KW_UNTIL: int = 155
val KW_USHR: int = 156
val KW_VAL: int = 157
val KW_VAR: int = 158
val KW_VOID: int = 159
val KW_WHILE: int = 160
val KW_XNOR: int = 161
val KW_XOR: int = 162


val keywordListLength: int = 63
val keywordListSlotSize: int = 16
val keywordTextSpace: blob[1008 * sizeof(char)]
...
private fun keywordListInit()
{
    ...
    String.strcpy(getKeywordText(8), "constructor")
    String.strcpy(getKeywordText(9), "continue")
    String.strcpy(getKeywordText(10), "do")
    String.strcpy(getKeywordText(11), "double")
    String.strcpy(getKeywordText(12), "elif")
    String.strcpy(getKeywordText(13), "else")
    String.strcpy(getKeywordText(14), "false")
    String.strcpy(getKeywordText(15), "final")
    String.strcpy(getKeywordText(16), "float")
    String.strcpy(getKeywordText(17), "for")
    String.strcpy(getKeywordText(18), "from")
    String.strcpy(getKeywordText(19), "fun")
    String.strcpy(getKeywordText(20), "if")
    String.strcpy(getKeywordText(21), "iff")
    String.strcpy(getKeywordText(22), "implies")
    String.strcpy(getKeywordText(23), "import")
    String.strcpy(getKeywordText(24), "inline")
    String.strcpy(getKeywordText(25), "int")
    String.strcpy(getKeywordText(26), "intrinsic")
    String.strcpy(getKeywordText(27), "inv")
    String.strcpy(getKeywordText(28), "is")
    String.strcpy(getKeywordText(29), "long")
    String.strcpy(getKeywordText(30), "loop")
    String.strcpy(getKeywordText(31), "mut")
    String.strcpy(getKeywordText(32), "nand")
    String.strcpy(getKeywordText(33), "native")
    String.strcpy(getKeywordText(34), "new")
    String.strcpy(getKeywordText(35), "niff")
    String.strcpy(getKeywordText(36), "nimplies")
    String.strcpy(getKeywordText(37), "nor")
    String.strcpy(getKeywordText(38), "null")
    String.strcpy(getKeywordText(39), "or")
    String.strcpy(getKeywordText(40), "package")
    String.strcpy(getKeywordText(41), "pass")
    String.strcpy(getKeywordText(42), "pointer")
    String.strcpy(getKeywordText(43), "private")
    String.strcpy(getKeywordText(44), "protected")
    String.strcpy(getKeywordText(45), "public")
    String.strcpy(getKeywordText(46), "repeat")
    String.strcpy(getKeywordText(47), "return")
    String.strcpy(getKeywordText(48), "shl")
    String.strcpy(getKeywordText(49), "short")
    String.strcpy(getKeywordText(50), "shr")
    String.strcpy(getKeywordText(51), "sizeof")
    String.strcpy(getKeywordText(52), "static")
    String.strcpy(getKeywordText(53), "struct")
    String.strcpy(getKeywordText(54), "true")
    String.strcpy(getKeywordText(55), "until")
    String.strcpy(getKeywordText(56), "ushr")
    String.strcpy(getKeywordText(57), "val")
    String.strcpy(getKeywordText(58), "var")
    String.strcpy(getKeywordText(59), "void")
    String.strcpy(getKeywordText(60), "while")
    String.strcpy(getKeywordText(61), "xnor")
    String.strcpy(getKeywordText(62), "xor")
}


val symbolDefStart: int = 1000
val TRIPLE_GREATER_EQUAL: int = 1000
val TRIPLE_LESS_EQUAL: int = 1001
val DOUBLE_LESS_EQUAL: int = 1002
val DOUBLE_GREATER_EQUAL: int = 1003
val DOUBLE_STAR_EQUAL: int = 1004
val BANG_CARET_EQUAL: int = 1005
val BANG_AMPERSAND_EQUAL: int = 1006
val BANG_PIPE_EQUAL: int = 1007
val BANG_DOUBLE_ARROW: int = 1008
val BANG_DOUBLE_EQUAL: int = 1009
val BANG_DOUBLE_AMPERSAND: int = 1010
val BANG_DOUBLE_PIPE: int = 1011
val NOT_ARROW: int = 1012
val DOUBLE_ARROW: int = 1013
val TRIPLE_EQUAL: int = 1014
val TILDE_EQUAL: int = 1015
val AMPERSAND_EQUAL: int = 1016
val PIPE_EQUAL: int = 1017
val CARET_EQUAL: int = 1018
val PLUS_EQUAL: int = 1019
val MINUS_EQUAL: int = 1020
val STAR_EQUAL: int = 1021
val SLASH_EQUAL: int = 1022
val PERCENT_EQUAL: int = 1023
val DOUBLE_EQUAL: int = 1024
val NOT_EQUAL: int = 1025
val GREATER_EQUAL: int = 1026
val LESS_EQUAL: int = 1027
val DOUBLE_PIPE: int = 1028
val DOUBLE_AMPERSAND: int = 1029
val DOUBLE_STAR: int = 1030
val DOUBLE_PLUS: int = 1031
val DOUBLE_MINUS: int = 1032
val ARROW: int = 1033
val EQUAL: int = 1034
val GREATER: int = 1035
val LESS: int = 1036
val CARET: int = 1037
val BANG_CARET: int = 1038
val BANG: int = 1039
val PLUS: int = 1040
val MINUS: int = 1041
val STAR: int = 1042
val SLASH: int = 1043
val PERCENT: int = 1044
val LEFT_PAREN: int = 1045
val RIGHT_PAREN: int = 1046
val LEFT_BRACKET: int = 1047
val RIGHT_BRACKET: int = 1048
val LEFT_BRACE: int = 1049
val RIGHT_BRACE: int = 1050
val SEMICOLON: int = 1051
val COMMA: int = 1052
val QUESTION: int = 1053
val COLON: int = 1054
val DOT: int = 1055
...
val TRIPLE_LESS_EQUAL_PATTERN: pointer<char> = "<<<="
...
val BANG_AMPERSAND_EQUAL_PATTERN: pointer<char> = "!&="
val BANG_PIPE_EQUAL_PATTERN: pointer<char> = "!|="
val BANG_DOUBLE_ARROW_PATTERN: pointer<char> = "!<->"
val BANG_DOUBLE_EQUAL_PATTERN: pointer<char> = "!=="
...
val TILDE_EQUAL_PATTERN: pointer<char> = "~="
val AMPERSAND_EQUAL_PATTERN: pointer<char> = "&="
...
val NOT_EQUAL_PATTERN: pointer<char> = "!="
...
val BANG_CARET_PATTERN: pointer<char> = "!^"
...
val rule2: pointer<TokenizeRule> = new TokenizeRule(2, TokenizeFSM.DEFAULT, "/\\*", beginBlockComment)
val rule3: pointer<TokenizeRule> = new TokenizeRule(3, TokenizeFSM.DEFAULT, "\\'", beginChar)
...
val rule14: pointer<TokenizeRule> = new TokenizeRule(14, TokenizeFSM.DEFAULT, ">>>=", eatTripleGreaterEqual)
val rule15: pointer<TokenizeRule> = new TokenizeRule(15, TokenizeFSM.DEFAULT, "<<<=", eatTripleLessEqual)
val rule16: pointer<TokenizeRule> = new TokenizeRule(16, TokenizeFSM.DEFAULT, "<<=", eatDoubleLessEqual)
val rule17: pointer<TokenizeRule> = new TokenizeRule(17, TokenizeFSM.DEFAULT, ">>=", eatDoubleGreaterEqual)
val rule18: pointer<TokenizeRule> = new TokenizeRule(18, TokenizeFSM.DEFAULT, "\\*\\*=", eatDoubleStarEqual)
val rule19: pointer<TokenizeRule> = new TokenizeRule(19, TokenizeFSM.DEFAULT, "!\\^=", eatBangCaretEqual)
val rule20: pointer<TokenizeRule> = new TokenizeRule(20, TokenizeFSM.DEFAULT, "!&=", eatBangAmpersandEqual)
val rule21: pointer<TokenizeRule> = new TokenizeRule(21, TokenizeFSM.DEFAULT, "!\\|=", eatBangPipeEqual)
val rule22: pointer<TokenizeRule> = new TokenizeRule(22, TokenizeFSM.DEFAULT, "!<->", eatBangDoubleArrow)
val rule23: pointer<TokenizeRule> = new TokenizeRule(23, TokenizeFSM.DEFAULT, "!==", eatBangDoubleEqual)
val rule24: pointer<TokenizeRule> = new TokenizeRule(24, TokenizeFSM.DEFAULT, "!&&", eatBangDoubleAmpersand)
val rule25: pointer<TokenizeRule> = new TokenizeRule(25, TokenizeFSM.DEFAULT, "!\\|\\|", eatBangDoublePipe)
val rule26: pointer<TokenizeRule> = new TokenizeRule(26, TokenizeFSM.DEFAULT, "!->", eatNotArrow)
val rule27: pointer<TokenizeRule> = new TokenizeRule(27, TokenizeFSM.DEFAULT, "<->", eatDoubleArrow)
val rule28: pointer<TokenizeRule> = new TokenizeRule(28, TokenizeFSM.DEFAULT, "===", eatTripleEqual)
val rule29: pointer<TokenizeRule> = new TokenizeRule(29, TokenizeFSM.DEFAULT, "~=", eatTildeEqual)
val rule30: pointer<TokenizeRule> = new TokenizeRule(30, TokenizeFSM.DEFAULT, "&=", eatAmpersandEqual)
val rule31: pointer<TokenizeRule> = new TokenizeRule(31, TokenizeFSM.DEFAULT, "\\|=", eatPipeEqual)
val rule32: pointer<TokenizeRule> = new TokenizeRule(32, TokenizeFSM.DEFAULT, "\\^=", eatCaretEqual)
val rule33: pointer<TokenizeRule> = new TokenizeRule(33, TokenizeFSM.DEFAULT, "\\+=", eatPlusEqual)
val rule34: pointer<TokenizeRule> = new TokenizeRule(34, TokenizeFSM.DEFAULT, "-=", eatMinusEqual)
val rule35: pointer<TokenizeRule> = new TokenizeRule(35, TokenizeFSM.DEFAULT, "\\*=", eatStarEqual)
val rule36: pointer<TokenizeRule> = new TokenizeRule(36, TokenizeFSM.DEFAULT, "/=", eatSlashEqual)
val rule37: pointer<TokenizeRule> = new TokenizeRule(37, TokenizeFSM.DEFAULT, "%=", eatPercentEqual)
val rule38: pointer<TokenizeRule> = new TokenizeRule(38, TokenizeFSM.DEFAULT, "==", eatDoubleEqual)
val rule39: pointer<TokenizeRule> = new TokenizeRule(39, TokenizeFSM.DEFAULT, "!=", eatNotEqual)
val rule40: pointer<TokenizeRule> = new TokenizeRule(40, TokenizeFSM.DEFAULT, ">=", eatGreaterEqual)
val rule41: pointer<TokenizeRule> = new TokenizeRule(41, TokenizeFSM.DEFAULT, "<=", eatLessEqual)
val rule42: pointer<TokenizeRule> = new TokenizeRule(42, TokenizeFSM.DEFAULT, "\\|\\|", eatDoublePipe)
val rule43: pointer<TokenizeRule> = new TokenizeRule(43, TokenizeFSM.DEFAULT, "&&", eatDoubleAmpersand)
val rule44: pointer<TokenizeRule> = new TokenizeRule(44, TokenizeFSM.DEFAULT, "\\*\\*", eatDoubleStar)
val rule45: pointer<TokenizeRule> = new TokenizeRule(45, TokenizeFSM.DEFAULT, "\\+\\+", eatDoublePlus)
val rule46: pointer<TokenizeRule> = new TokenizeRule(46, TokenizeFSM.DEFAULT, "--", eatDoubleMinus)
val rule47: pointer<TokenizeRule> = new TokenizeRule(47, TokenizeFSM.DEFAULT, "->", eatArrow)
...
val rule52: pointer<TokenizeRule> = new TokenizeRule(52, TokenizeFSM.DEFAULT, "!\\^", eatBangCaret)
val rule53: pointer<TokenizeRule> = new TokenizeRule(53, TokenizeFSM.DEFAULT, "!", eatBang)
val rule54: pointer<TokenizeRule> = new TokenizeRule(54, TokenizeFSM.DEFAULT, "\\+", eatPlus)
val rule55: pointer<TokenizeRule> = new TokenizeRule(55, TokenizeFSM.DEFAULT, "-", eatMinus)
val rule56: pointer<TokenizeRule> = new TokenizeRule(56, TokenizeFSM.DEFAULT, "\\*", eatStar)
val rule57: pointer<TokenizeRule> = new TokenizeRule(57, TokenizeFSM.DEFAULT, "/", eatSlash)
val rule58: pointer<TokenizeRule> = new TokenizeRule(58, TokenizeFSM.DEFAULT, "%", eatPercent)
val rule59: pointer<TokenizeRule> = new TokenizeRule(59, TokenizeFSM.DEFAULT, "\\(", eatLeftParen)
val rule60: pointer<TokenizeRule> = new TokenizeRule(60, TokenizeFSM.DEFAULT, "\\)", eatRightParen)
val rule61: pointer<TokenizeRule> = new TokenizeRule(61, TokenizeFSM.DEFAULT, "\\[", eatLeftBracket)
val rule62: pointer<TokenizeRule> = new TokenizeRule(62, TokenizeFSM.DEFAULT, "\\]", eatRightBracket)
val rule63: pointer<TokenizeRule> = new TokenizeRule(63, TokenizeFSM.DEFAULT, "\\{", eatLeftBrace)
val rule64: pointer<TokenizeRule> = new TokenizeRule(64, TokenizeFSM.DEFAULT, "\\}", eatRightBrace)
val rule65: pointer<TokenizeRule> = new TokenizeRule(65, TokenizeFSM.DEFAULT, ";", eatSemicolon)
val rule66: pointer<TokenizeRule> = new TokenizeRule(66, TokenizeFSM.DEFAULT, ",", eatComma)
val rule67: pointer<TokenizeRule> = new TokenizeRule(67, TokenizeFSM.DEFAULT, "\\?", eatQuestion)
...
private fun beginLineComment(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> = changeState(input, LINE_COMMENT_STATE, dest)


private fun beginBlockComment(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> = changeState(input, BLOCK_COMMENT_STATE, dest)


private fun beginChar(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token>
{
...
private fun beginString(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token>
{
    dest.accumulator.clear()
...
private fun eatIntLit(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> = eatToken(input, TK_INTEGER, dest)


private fun eatLongLit(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> = eatToken(input, TK_LONG, dest)


private fun eatFloatLit(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> = eatToken(input, TK_FLOAT, dest)


private fun eatDoubleLit(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> = eatToken(input, TK_DOUBLE, dest)


private fun eatLongDoubleLit(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> = eatToken(input, TK_LONG_DOUBLE, dest)
...
private fun eatTripleLessEqual(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, TRIPLE_LESS_EQUAL, dest)
...
private fun eatBangAmpersandEqual(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, BANG_AMPERSAND_EQUAL, dest)

private fun eatBangPipeEqual(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, BANG_PIPE_EQUAL, dest)

private fun eatBangDoubleArrow(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, BANG_DOUBLE_ARROW, dest)

private fun eatBangDoubleEqual(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, BANG_DOUBLE_EQUAL, dest)
...
private fun eatTildeEqual(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, TILDE_EQUAL, dest)

private fun eatAmpersandEqual(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, AMPERSAND_EQUAL, dest)
...
private fun eatNotEqual(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, NOT_EQUAL, dest)
...
private fun eatBangCaret(input: pointer<LexInput>, dest: pointer<TokenizeFSM>) -> pointer<Token> =
    eatToken(input, BANG_CARET, dest)
