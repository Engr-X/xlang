...
private fun addCommonBanKinds(set: pointer<HashSet>)
{
    ...
    addBanKind(set, Tokenizer.BANG_EQUAL)
    addBanKind(set, Tokenizer.GREATER_EQUAL)
    addBanKind(set, Tokenizer.LESS_EQUAL)
    addBanKind(set, Tokenizer.DOUBLE_GREATER)
    addBanKind(set, Tokenizer.DOUBLE_LESS)
    ...
    addBanKind(set, Tokenizer.DOUBLE_DOT)
    addBanKind(set, Tokenizer.ARROW)
    addBanKind(set, Tokenizer.FAT_ARROW)
    addBanKind(set, Tokenizer.DOUBLE_COLON)
    ...
    addBanKind(set, Tokenizer.AT)
    addBanKind(set, Tokenizer.DOLLAR)
