 ...
 * {@code xlang_*} runtime bindings implemented in C (for example
 * {@code xlang_sin}, {@code xlang_log10}, and {@code xlang_sqrt}).
 ...
 * in native xlang programs without calling backend-specific C symbols
 * directly.
 *
 * <p>Example:
 * <pre>{@code
 ...
 * The implementation delegates to the native runtime binding
 * {@code xlang_sin} (C {@code sin}).
 *
 * Special cases:
 * <ul>
 ...
 * </ul>
 *
 * The computation delegates to native binding {@code xlang_asin} and returns
 ...
 * </ul>
 *
 * The computation delegates to native binding {@code xlang_acos} and returns
 * a floating-point approximation consistent with IEEE-754 behavior.
 *
 ...
 * </ul>
 *
 * The computation delegates to native binding {@code xlang_atan}.
 *
 ...
 *
 * <p>This delegates to native binding {@code xlang_exp} (C {@code exp}).
 *
 ...
 *
 * <p>This delegates to native binding {@code xlang_ln} (C {@code log}).
 *
 * @param x     input value
 * @return      {@code ln(x)}
 */
 ...
 *
 * <p>This delegates to native binding {@code xlang_log10} (C {@code log10}).
 *
 * @param x     input value
 * @return      {@code log10(x)}
 */
 ...
 *
 * <p>This delegates to native binding {@code xlang_sqrt} (C {@code sqrt}).
 *
 * @param x     input value
 * @return      {@code sqrt(x)}
 */
 ...
 *
 * <p>This delegates to native binding {@code xlang_cbrt} (C {@code cbrt}).
 *
 * @param x     input value
 * @return      {@code cbrt(x)}
 */
