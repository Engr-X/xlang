...
/**
 * {@code xlang.Math} is the native standard math utility module for xlang.
 * It provides one unified API surface for numerical constants, trigonometric
 * functions, logarithmic/exponential operations, angle conversion helpers,
 * and integer predicates such as parity and primality checks.
 *
 * <p>For native targets, floating-point operations are routed through
 * {@code java.lang.StrictMath.*} runtime bindings implemented in Java std (for example
 * {@code StrictMath.sin}, {@code StrictMath.log10}, and {@code StrictMath.sqrt}).
 * This keeps behavior explicit at the runtime boundary and reuses the
 * platform math library implementation.
 *
 * <p>Use this class when you want readable formulas and consistent naming
 * in native xlang programs without calling backend-specific Java symbols
 * directly.
 *
 * <p>Example:
 * <pre>{@code
 *      val rad: double = toRadians(90.0)
 *      val y: double = sin(rad) + ln(E)
 ...
 */
inline fun succ(x: int) -> int = Math.addExact(x, 1)
 ...
 * @return      {@code x + 1} when no overflow occurs
 */
inline fun succ(x: long) -> long = Math.addExact(x, 1L)
 ...
 * @return      {@code x - 1} when no overflow occurs
 */
inline fun pred(x: int) -> int = Math.subtractExact(x, 1)
 ...
 */
inline fun pred(x: long) -> long = Math.subtractExact(x, 1L)
 ...
 */
@native("java.lang.StrictMath.cos")
 ...
 */
@native("java.lang.StrictMath.tan")
 ...
 */
inline fun sec(x: double) -> double = 1.0 / StrictMath.cos(x)
 ...
 */
inline fun csc(x: double) -> double = 1.0 / StrictMath.sin(x)
 ...
 */
inline fun cot(x: double) -> double = 1.0 / StrictMath.tan(x)
...
*/
@native("java.lang.StrictMath.asin")
native inline fun asin(x: double) -> double
 ...
 */
@native("java.lang.StrictMath.acos")
native inline fun acos(x: double) -> double
 ...
 */
@native("java.lang.StrictMath.atan")
 ...
 */
inline fun asec(x: double) -> double = StrictMath.acos(1.0 / x)
 ...
 */
inline fun acsc(x: double) -> double = StrictMath.asin(1.0 / x)
 ...
 */
inline fun acot(x: double) -> double = StrictMath.atan(1.0 / x)
 ...
 * @return      {@code e^x}
 */
@native("java.lang.StrictMath.exp")
 ...
 * @return      {@code ln(x)}
 */
@native("java.lang.StrictMath.log")
 ...
 *
 * @param x     input value
 * @return      {@code log(x)} (a type alias for ln)
 */
@native("java.lang.StrictMath.log")
native inline fun log(x: double) -> double
 ...
 */
inline fun log(base: double, x: double) -> double = StrictMath.log(x) / StrictMath.log(base)
 ...
 * @return      {@code log2(x)}
 */
inline fun log2(x: double) -> double = StrictMath.log(x) / LN2;
 ...
 * @return      {@code log10(x)}
 */
@native("java.lang.StrictMath.log10")
 ...
 * @return      {@code sqrt(x)}
 */
@native("java.lang.StrictMath.sqrt")
 ...
 * @return      {@code cbrt(x)}
 */
@native("java.lang.StrictMath.cbrt")
 ...
 *
 * @param       x the value to test.
 * @return      true if x is odd; otherwise false.s
 */
